...
//      return Sorting.mergeSort(euclidianFromHouseF, (FSharpList<Vector2>)specialBuildings);
      ...
      var euclidianFromHouseC = Euclidian(house); 
      MergeSort(ref specialBuildings, 0, specialBuildings.Count(), euclidianFromHouseC);
    ...
    private static IEnumerable<Tuple<Vector2, Vector2>> FindRoute(Vector2 startingBuilding,
      ...
      var fakeBestPath = new List<Tuple<Vector2, Vector2>>() { startingRoad };
